      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {showControls && (
            <div className="bg-canvas border border-hairline rounded-md p-4 space-y-4 shadow-sm">
              <div className="flex items-center gap-2">
                <div className="flex-1 flex items-center h-10 px-3 bg-surface-soft border border-hairline-soft rounded-md text-xs font-bold text-ink-soft select-none">
                  {bodyParts[selectedBodyPart]?.label || "Chest / Thorax"}
                </div>
                <button
        ...
        <div className="lg:col-span-7 bg-canvas border border-hairline rounded-md overflow-hidden shadow-sm flex flex-col min-h-[480px]">
          {ai ? (
            <>
              {/* Tabs */}
              <div className="flex border-b border-hairline shrink-0 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                {[
